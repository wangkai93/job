		 	...
		 	<c:if test="${ ! empty resumeList }">
		 		<c:forEach items="${resumeList }" var="resume">
					<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> 
				      ...
				      <a title="信息预览" href="javascript()" onclick="window.open('${pageContext.request.contextPath }/resume/show/${resume.id}','newwin','dialogHeight:400px;   dialogWidth:   600px;   dialogTop:0px;   dialogLeft:   5px;   edge:   Raised;   center:   Yes;   help:   Yes;   resizable:   Yes;   status:yes;');" target="_blank">${resume.job }</a></td>
